...
// import 'package:vndy_duex/providers/mail_service.dart';
// import 'package:vndy_duex/providers/product.dart';
// import 'package:vndy_duex/providers/products_provider.dart';
// import 'package:vndy_duex/providers/shippments_provider.dart';
// import 'package:provider/provider.dart';
// import 'package:vndy_duex/shared/loading.dart';
// import 'package:carousel_slider/carousel_slider.dart';
// import 'package:vndy_duex/providers/resources.dart' as Resources;
...
//     // }
//
//     for (int i = 0; i < loadedProduct.imageUrls.length; i++) {
//       final url = loadedProduct.imageUrls[i];
//       if (url.trim().isNotEmpty && url != 'null') {
//         imgList.add(url);
//         print('URL$i ADDED');
//         print('URL$i => $url');
//       }
...
//                                       String _transferId = loadedProduct.transferId.toString();
...
//                                       //executeRefundAndReversal(_piToken,_transferId);
//                                       await cancelPaymentIntent(loadedProduct.piToken);
//                                       print('return executeRefund');
//                                       {
//                                         try {
//                                           await Provider.of<Shippments>(context, listen: false).deleteShippment(loadedProduct.id, loadedProduct.imageUrls.first);
//                                         } catch (error) {
...
//                                         ),
//                                       );
//                                       //await capturePaymentIntent(loadedProduct.piToken);
//                                       final captureResponse = await capturePaymentIntent(loadedProduct.piToken);
//                                       final chargeId = captureResponse['charges']['data'][0]['id'].toString(); // ✅ OK
//
//
//                                       await createTransferIntent(loadedProduct.fee, 'USD', Resources.STRIPE_CONNECT, chargeId);
//                                       print('confirmed pressed, send text message that purchased is confirmed, print shipping label');
...
//   // } //executeRefund
//
//   // executeRefundAndReversal(String piToken, String transferId) async {
//   //   print('💳 Starting full refund: piToken=$piToken, transferId=$transferId');
//   //
//   //   try {
//   //     // 1. Refund the customer
//   //     Map<String, dynamic> refundBody = {'payment_intent': piToken};
//   //     var refundResponse = await http.post(
//   //       Uri.parse('https://api.stripe.com/v1/refunds'),
//   //       body: refundBody,
//   //       headers: {
//   //         'Authorization': 'Bearer ${dotenv.env['STRIPE_SECRET']}',
...
//   //       },
//   //     );
//   //     print('✅ Customer refund response: ${refundResponse.body}');
//   //
//   //     // Optional: You can parse this if you want the refundId
//   //     final refundData = jsonDecode(refundResponse.body);
//   //     final refundId = refundData['id'] ?? 'unknown';
//   //     print('✅ Refund ID: $refundId');
//   //
//   //     // 2. Reverse the transfer (platform refund)
//   //     var reversalResponse = await http.post(
//   //       Uri.parse('https://api.stripe.com/v1/transfers/$transferId/reversals'),
//   //       headers: {
//   //         'Authorization': 'Bearer ${dotenv.env['STRIPE_SECRET']}',
//   //         'Content-Type': 'application/x-www-form-urlencoded',
//   //       },
//   //     );
//   //     print('✅ Transfer reversal response: ${reversalResponse.body}');
//   //
//   //     final reversalData = jsonDecode(reversalResponse.body);
//   //     final reversalId = reversalData['id'] ?? 'unknown';
//   //     print('🔁 Transfer Reversal ID: $reversalId');
//   //
//   //     print('✅ All refunds completed successfully.');
//   //
//   //   } catch (err, stack) {
//   //     print('❌ Error during refund process: $err');
//   //     print('🔍 Stack trace:\n$stack');
//   //   }
//   // }
//
//   Future<Map<String, dynamic>> capturePaymentIntent(String paymentIntentId) async {
//     try {
...
//         return jsonDecode(response.body);
//       } else {
//         print('❌ Failed to capture PaymentIntent: ${response.body}');
//         throw Exception('Failed to capture PaymentIntent');
//       }
//
//     } catch (e, stackTrace) {
//       print('❌ Exception in capturePaymentIntent: $e');
//       print('🔍 StackTrace: $stackTrace');
//       throw Exception('Exception during capturePaymentIntent');
//     }
//   }
//
//
//   Future<void> cancelPaymentIntent(String _piToken) async {
//     try {
//       print('🚫 Canceling PaymentIntent => $_piToken');
//       final response = await http.post(
//         Uri.parse('https://api.stripe.com/v1/payment_intents/$_piToken/cancel'),
//         headers: {
//           'Authorization': 'Bearer ${dotenv.env['STRIPE_SECRET']}',
//           'Content-Type': 'application/x-www-form-urlencoded',
//         },
...
//     } catch (err) {
//       print('❌ Error canceling payment: ${err.toString()}');
//     }
//   }
//
//   Future<String?> createTransferIntent(
//       String amount,
//       String currency,
//       String destination,
//       String charges,
...
//         'transfer_group': 'VNDY_Group',
//         'source_transaction': charges,
//       };
//
//       print('body ===> $body');
//
...
//       print('*** Transfer Response ===> $decoded');
//
//       if (response.statusCode == 200 && decoded['id'] != null) {
//         final transferId = decoded['id'];
//         print('✅ TransferId: $transferId');
//         return transferId; // ✅ Return just the String
//       } else {
//         print('❌ Failed to create transfer. Response: ${response.body}');
//         return null;
//       }
//     } catch (err) {
//       print('❌ Error in createTransferIntent: $err');
//       return null;
//     }
//   }
//
